...
- **Nota de nomenclatura**: o teste foi originalmente catalogado no Atomic Red Team como T1070.001 (ver seção Processo). No momento deste teste, o caminho válido no repositório é `atomics/T1685.005/`.
